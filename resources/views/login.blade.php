...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded shadow-md w-96">
        ...
        <!-- Registration form -->
        <form action="{{ route('login_verification') }}" method="POST">
            @csrf
            <!-- Name -->
            <div class="mb-4">
            ...
            <!-- Register button -->
            <button type="submit" class="w-full bg-blue-500 text-white py-2 px-4 rounded focus:outline-none hover:bg-blue-700">Login</button>
        </form>
    </div>
</body>
</html>
